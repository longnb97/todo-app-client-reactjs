...
class TaskCommentComponent extends Component {
        ...
        .then(resCreateComment => {
          ...
          if (resCreateComment.data.success === 1) {
            ...
            this.setState({
              ...
              loadCommentErr: this.formatTime,
              sendingComment: false,
              newCommentContent: ""
            });
          }
  ...
  openFormTaskComment() {
    ...
    if (isOpenFormAdd === false) {
      setTimeout(() => {
        if (
          this.props.currentTask.id !== null &&
          this.props.currentTask.id !== undefined &&
          this.props.currentTask.id !== ""
        ) {
          this.setState({ loadingComment: true }, () => {
            console.log(this.props.currentTask.id);
            getAllCommentInTask(this.props.currentTask.id)
              .then(restComments => {
                if (restComments && restComments.data.success === 1) {
                  console.log("co");
                  this.setState(
                    {
                      listComment: restComments.data.data,
                      loadCommentErr: false,
                      loadingComment: false,
                      noComment : false
                    },
                ...
                } else if (restComments && restComments.data.success === 0) {
                  console.log("rong");
                  this.setState(
                    {
                      listComment: restComments.data.data,
    ...
    return (
      ...
      >
        ...
        <div className="task-comment">
          <p className="btn exit-button" onClick={this.openFormTaskComment}>
            {" "}
          ...
          <Row className="Col-reset">
            <Col
              ...
              md={8}
              lg={8}
              className="no-padding text-center col-comment-custom border-col-left pos-relative"
            >
              <div className="cover-coment">
                ...
                <p
                  className={
                    this.state.loadCommentErr === true &&
              ...
              <div className="create-new-comment">
                ...
                >
                  <i
                    className={
                      this.state.sendingComment !== true
                        ? "fa fa-paper-plane"
                        : "d-none"
                    }
                    aria-hidden="true"
            ...
            <Col
              ...
              md={4}
              lg={4}
              className="no-padding text-center col-comment-custom"
            >
              <div className="cover-img">
                <img
                  className="img-task"
                  src={
                    this.props.currentTask.image !== "" &&
                    this.props.currentTask.image !== "none"
                      ? this.props.currentTask.image
                      : ""
                  }
                  alt="img"
              ...
              <div className="task-info">
                ...
                <p className="task-description-detail">
                  ...
                  <span className="user-comment">
                    {" "}
                    {this.props.currentTask.created_at}{" "}
                  </span>
                </p>
                <hr />
                <p className="task-description-detail">
                  ...
                  <span className="user-comment">
                    {" "}
                    {this.props.currentTask.due_date}{" "}
                  </span>
                </p>
                <hr />
              </div>
